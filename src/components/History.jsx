          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-2 grid grid-cols-2 gap-2 text-sm">
                ...
                <div className="break-words">Black: {result.color_percentages.Black}%</div>
                <div className="break-words">Dark P: {result.color_percentages['Dark Purple']}%</div>
                <div className="break-words">Light P: {result.color_percentages['Light Purple']}%</div>
                <div className="break-words">Brown: {result.color_percentages.Brown}%</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-6xl h-[90vh] flex flex-col overflow-hidden">
        <div className="p-4 sm:p-6 border-b border-gray-100 flex justify-between items-center">
          ...
          <div className="flex gap-2 sm:gap-4">
            <button
              onClick={onClear}
              className="text-sm px-3 py-1.5 sm:px-4 sm:py-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors"
            >
              Clear History
            </button>
            <button
